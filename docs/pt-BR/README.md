...
| <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/filebrowser.svg" width="48" height="48" alt=""> | [FileBrowser](../../apps/filebrowser/README.pt-BR.md) | `1.5.1-stable` | Gerenciador de arquivos web — busca, miniaturas, WebDAV e um shell sobre um diretório que você escolhe |
