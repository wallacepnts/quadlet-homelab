...
| <img src="https://cdn.simpleicons.org/macos/000000" width="48" height="48" alt=""> | [macOS](../../apps/macos/README.pt-BR.md) | `3.09` | VM de macOS num container — só em hardware Apple, ver o README antes de instalar |
...
| <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/qemu.svg" width="48" height="48" alt=""> | [QEMU](../../apps/qemu/README.pt-BR.md) | `7.44` | Qualquer SO numa VM, instalado de uma lista de 23 distros ou da sua própria ISO, visto pelo navegador |
...
| <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/windows-11.png" width="48" height="48" alt=""> | [Windows](../../apps/windows/README.pt-BR.md) | `6.04` | VM de Windows num container, acessível pelo navegador ou por RDP — exige KVM no host |
