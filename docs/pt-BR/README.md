...
| <img src="https://cdn.jsdelivr.net/gh/Templarian/MaterialDesign-SVG@v7.4.47/svg/email-fast.svg" width="48" height="48" alt=""> | [Postfix](../../apps/postfix/README.pt-BR.md) | `v5.1.0` | Relay SMTP para os outros containers — eles entregam num lugar só, e a credencial do provedor fica só aqui |
