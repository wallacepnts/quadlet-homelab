...
| <img src="https://cdn.jsdelivr.net/gh/containers/containertoolbx.org@main/assets/logo/toolbx-logo.svg" width="48" height="48" alt=""> | [Toolbx](../../apps/toolbx/README.pt-BR.md) | — | Shells descartáveis de Arch, Fedora, RHEL e Ubuntu, nas imagens oficiais do Toolbx — um lugar pra instalar ferramenta avulsa que não é o host |
