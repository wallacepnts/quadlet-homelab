...
Rules to follow for any new service in this repository (Podman 6.0.2 — every
unit here is generated by its Quadlet, and 6.0 dropped cgroups v1, CNI and
slirp4netns, none of which this repository asked for).
