...
| <img src="https://cdn.jsdelivr.net/gh/Templarian/MaterialDesign-SVG@v7.4.47/svg/email-fast.svg" width="48" height="48" alt=""> | [Postfix](./apps/postfix) | `v5.1.0` | An SMTP relay for the other containers — they hand mail to one place, and the credentials of the provider live here only |
