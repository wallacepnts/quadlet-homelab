...
| <img src="https://cdn.simpleicons.org/macos/000000" width="48" height="48" alt=""> | [macOS](./apps/macos) | `3.09` | A macOS VM in a container — Apple hardware only, see the README before installing |
...
| <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/qemu.svg" width="48" height="48" alt=""> | [QEMU](./apps/qemu) | `7.44` | Any OS in a VM, installed from a list of 23 distros or your own ISO, viewed in the browser |
...
| <img src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/png/windows-11.png" width="48" height="48" alt=""> | [Windows](./apps/windows) | `6.04` | A Windows VM in a container, reachable in the browser or over RDP — needs KVM on the host |
